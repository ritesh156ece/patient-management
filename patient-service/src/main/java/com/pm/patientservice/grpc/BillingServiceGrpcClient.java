...
public class BillingServiceGrpcClient {
  ...
  public BillingServiceGrpcClient(
    ...
    log.info(
        "Initializing BillingServiceGrpcClient with server address: {} and port: {}",
        serverAddress,
        serverPort);
  ...
  public BillingResponse createBillingAccount(String patientId, String name, String email) {
    log.info(
        "Creating billing account for patientId: {}, name: {}, email: {}", patientId, name, email);
    billing.BillingRequest request =
        billing.BillingRequest.newBuilder()
